      ...
      <div className="stockChartActions">
        ...
        <div className="stockChartActions-body">
          ...
          {stockAction === 'buy' ?
              <form>
              <div className="mb-3">
                <label htmlFor="inputProductType" className="form-label">Product: </label>
              ...
              <div className="mb-3">
                <label htmlFor="inputStockTotalPrice" className="form-label">Price: </label>
                <input type="number" className="form-control" id="inputStockTotalPrice" disabled value={buyQuantity * stockPrice} />
              </div>
              <button className="btn btn-success submit-button" onClick={buyStock}>Buy now</button>
          </form>
      :
            <form>
                <div className="mb-3">
                ...
                <button  className="btn btn-danger submit-button" onClick={sellStock}>Sell now</button>
            </form>
          }
